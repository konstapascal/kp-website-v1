...
function ProjectCard({ title, subtitle, description, urls, labels }) {
	return (
		<div className='bg-main-dark mt-12 lg:mt-10 first:mt-0   md:shadow-2xl offset lg:flex-row xl:hover:scale-105 transform-gpu lg:max-w-6xl transition-transform flex flex-col max-w-[500px] duration-200 border-b-2 border-r-2 border-green-400 rounded shadow-md'>
			<img
				src={`${urls.imgPath}`}
				width={500}
				height={250}
