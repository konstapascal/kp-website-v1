...
function BlogPost() {
	return (
		<div className='my-14'>
			...
			<p className=' dark:text-gray-400 mt-2 text-gray-500 transition duration-200 ease-in'>
				by{' '}
			...
			<p className='text-md md:text-lg lg:text-xl dark:text-gray-300 mt-4 text-gray-900 transition duration-200 ease-in'>
