		...
		<section>
			<div className='bg-main-dark relative flex items-center justify-center min-h-screen overflow-hidden border-b-2 border-green-400'>
				...
				<div className=' lg:max-w-3xl lg:text-left top-1/4 container absolute px-4 text-center'>
					<div className=' duration-1000 opacity-0' id='heading'>
					...
					<p
						id='description'
						className='text-md md:text-lg lg:text-xl lg:mt-6 lg:mb-12 mt-4 mb-8 text-gray-100 duration-1000 opacity-0'>
					...
					{/* RESUME AND LINKS */}
					<div
						className=' lg:justify-start sm:flex-row flex flex-col-reverse items-center justify-center duration-1000 opacity-0'
						id='links'>
						<a
